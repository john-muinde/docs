...
<Card
  ...
  icon="shield"
  href="/v3/api-reference/authentication/login"
>
...
<Card
  ...
  icon="flask"
  href="/v3/api-reference/introduction"
>
  Test your integration safely: `https://sandbox-api.kotanipay.com`
</Card>

<Card
  title="Crypto Bridge Tester"
  icon="external-link"
  href="https://sandbox-api.kotanipay.com/crypto-bridge-tester"
>
