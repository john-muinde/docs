...
All four resolve to the same reserved outcome. Format doesn't matter either —
`+254700000010`, `254700000010` and `0700000010` are the same number.

So the tables below list the **nine-digit ending**. Prefix it with the country code
for the corridor you're testing.
