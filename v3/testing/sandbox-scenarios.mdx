...
<Warning>
Always send phone numbers in international format, with the country code. A
national-format number like `0700000010` is ambiguous — the same digits are a real
number in several countries we support — and depends on you sending `countryCode`
alongside it. Use `+254700000010`, not `0700000010`.
</Warning>
