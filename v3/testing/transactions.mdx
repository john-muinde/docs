...
Use as the beneficiary account number.

| Account number | Settles as | After |
| --- | --- | --- |
| `1000000001` | Success | ~5s |
| `1000000002` | Success | ~5s |
| `1000000010` | Failed — account not found | ~5s |
| `1000000011` | Failed — account frozen | ~5s |
| `1000000012` | Failed — limit exceeded | ~5s |
| `1000000020` | Never settles | — |
| `1000000021` | Success | ~60s |
...
<AccordionGroup>
  <Accordion title="A payout that fails">
    `1000000010` on a bank payout, or `+254700000010` on mobile money. Confirm
  ...
  <Accordion title="Paying the wrong person">
    `1000000002` succeeds but is registered to a different name than
    `1000000001`. Pair it with
