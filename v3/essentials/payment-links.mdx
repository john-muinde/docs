...
Links can also be created over the API if you need one per order rather than one
you share repeatedly. Talk to your account manager to get set up for it.
