...
description: "Complete sequence diagrams for payment link creation and transactions"
---

# Payment Links Flow

Payment links allow integrators to collect payments without building a full checkout experience. Create a link once, share it anywhere, and start accepting payments via multiple methods.
