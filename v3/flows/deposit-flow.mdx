...
- Funds credited after reconciliation
...
- **Unique References**: Always provide unique `reference_id` values
- **Implement Webhooks**: Set up webhook endpoint for real-time status updates
- **Handle All Statuses**: Integration should handle all transaction statuses gracefully